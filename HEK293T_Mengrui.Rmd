...
head(go_input_NFlag)
write.csv(go_input_NFlag, file="./Data_Files/apo_NFlag_24.csv", quote=F, row.names=FALSE)
...
head(go_input_NLSFlag)
write.csv(go_input_NLSFlag, file="./Data_Files/apo_NLSFlag_24.csv", quote=F, row.names=FALSE)
...
head(go_input_NNLS)
write.csv(go_input_NNLS, file="./Data_Files/apo_NNLS_24.csv", quote=F, row.names=FALSE)
```
